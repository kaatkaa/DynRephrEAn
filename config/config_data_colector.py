...
class DataProvider:
    ...
    __color_sentiment = {'Meliorization':'#3FEE0F','M_strong':'#28B900','M_weak':'#7CFF57','Pejorativization':'#FF0000'
                     ,'P_strong':'#BD0000','P_weak':'#FF5656','Neutralization':'#2EBDFF','No_Change': '#414040'}
    __color_ethos = {'Meliorization':'#3FEE0F','M_strong':'#28B900','M_weak':'#7CFF57','Pejorativization':'#FF0000'
                     ,'P_strong':'#BD0000','P_weak':'#FF5656','Neutralization':'#2EBDFF','No_Change': '#414040'}
